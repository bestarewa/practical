...
This game engine manages 12 lines.
name (a string) as shown here:
Each line is distinguished by its
...
sq must be one of the strings 'LeftTop', 'RightTop',
'LeftBottom', or 'RightBottom'.Returns None if the square has no owner. """
    if sq =='LeftTop':
